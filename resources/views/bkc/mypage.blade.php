    ...
    <main>
      ...
      <section id="mypage" class="view" aria-labelledby="mypage-title">
        ...
        <div class="card" style="margin-top:14px; max-width:720px;">
          ...
          <form>
            <div class="field"><label>現在のパスワード</label><input type="password" placeholder="現在のパスワード" /></div>
            <div class="field"><label>新しいパスワード</label><input type="password" placeholder="8文字以上" /></div>
            <div class="field"><label>新しいパスワード（確認）</label><input type="password" placeholder="もう一度入力" /></div>
            <div class="btn-row"><button type="button" class="btn primary">更新する</button></div>
          </form>
        </div>
          ...
          <div class="card">
            ...
            <div class="mpnew-forms">
              ...
              <form id="mpnew-form-drive" class="view">
                <div class="field"><label>名称</label><input type="text" placeholder="例）メタセコイア並木 / 三井アウトレット滋賀竜王" /></div>
                <div class="field"><label>住所</label><input type="text" placeholder="例）滋賀県高島市… / 滋賀県蒲生郡竜王町…" /></div>
                <div class="field"><label>大学からの時間</label><input type="text" placeholder="例）車で30分 / 1時間45分" /></div>
                <div class="field"><label>URL</label><input type="url" placeholder="https://example.com" /></div>
                ...
                <div class="field"><label>詳細</label><textarea placeholder="例）見どころ・設備・注意事項など"></textarea></div>
                <div class="btn-row"><button type="button" class="btn primary">掲載する</button><button type="reset" class="btn">消去</button></div>
              </form>

              <!-- カラオケ新規作成フォーム -->
              <form id="mpnew-form-karaoke" class="view">
                <div class="field"><label>店名</label><input type="text" placeholder="例）JOYJOY 南草津店" /></div>
                <div class="field"><label>住所</label><input type="text" placeholder="例）滋賀県草津市…" /></div>
                <div class="field"><label>持ち込み</label><input type="text" placeholder="例）自由（夜はアルコール飲み放題）" /></div>
                <div class="field"><label>機種</label><input type="text" placeholder="例）JOYSOUND / DAM" /></div>
                <div class="field"><label>営業時間</label><input type="text" placeholder="例）24時間 / 平日10:00–翌5:00" /></div>
                <div class="field"><label>設備</label><input type="text" placeholder="例）店内Wi‑Fi、HDMI貸出、ダーツ等" /></div>
                <div class="field"><label>URL</label><input type="url" placeholder="https://example.com" /></div>
                <div class="field"><label>詳細</label><textarea placeholder="例）予約可否、注意事項など"></textarea></div>
                <div class="btn-row"><button type="button" class="btn primary">掲載する</button><button type="reset" class="btn">消去</button></div>
              </form>

              <!-- 居酒屋新規作成フォーム -->
              <form id="mpnew-form-izakaya" class="view">
                <div class="field"><label>店名</label><input type="text" placeholder="例）○○酒場" /></div>
                <div class="field"><label>距離/時間</label><input type="text" placeholder="例）大学から徒歩8分" /></div>
                <div class="field"><label>予算</label><input type="text" placeholder="例）¥2,500〜¥3,500" /></div>
                <div class="field"><label>特徴</label><input type="text" placeholder="例）飲み放題あり / 個室 / 喫煙可" /></div>
                <div class="field"><label>URL</label><input type="url" placeholder="https://example.com" /></div>
                <div class="field"><label>詳細</label><textarea placeholder="例）席数、予約、注意事項など"></textarea></div>
                <div class="btn-row"><button type="button" class="btn primary">掲載する</button><button type="reset" class="btn">消去</button></div>
              </form>
            </div>
