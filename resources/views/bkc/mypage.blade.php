    ...
    <main>
      ...
      <section id="mypage" class="view" aria-labelledby="mypage-title">
        ...
        <div class="card" style="margin-top:14px; max-width:720px;">
          ...
          <p class="meta" style="margin-bottom:12px;">パスワードを変更する場合は、専用ページで行ってください。</p>
          <div class="btn-row">
        ...
        <div class="cols" style="margin-top:14px;">
          ...
          <div class="card">
            ...
            <p class="meta" style="margin-bottom:12px;">新しい掲載を作成する場合は、専用ページで行ってください。</p>
            <div class="btn-row">
              <a href="http://localhost:8000/places/create" class="btn primary">新しく掲載を作成ページへ</a>
            </div>
          </div>
          ...
          <div class="card">
            ...
            <p class="meta" style="margin-bottom:12px;">掲載の一覧表示と編集を行う場合は、専用ページで行ってください。</p>
            <div class="btn-row">
              <a href="/places/edit" class="btn primary">あなたの掲載一覧ページへ</a>
            </div>
          </div>
        </div>
      </section>
